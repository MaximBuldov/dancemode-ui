import { Typography, Checkbox, Col, Row, Space, Tag, Button } from 'antd';
    ...
    <Row justify="space-between">
      <Col>
        <Space>
          ...
          {(isOutOfStock && isInWaitList) && <Tag color="cyan">In wait list</Tag>}
          {(isOutOfStock && !isInWaitList) && <Button
            size="small"
            ghost
            type="primary"
            loading={isPending}
